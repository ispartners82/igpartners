...
const MENU_TRANSLATIONS = {
  ...
  en: { langSelect: 'Language', home: 'Home', about: 'About Us', services: 'Services', interpretation: 'Professional Interpretation', booking: 'Book Appointment', partners: 'Partners', community: 'Community', myRes: '📅 My Bookings', admin: '👑 Admin', stats: '📊 Stats', logout: 'Logout', login: 'Login' },
  zh: { langSelect: '选择语言', home: '首页', about: '公司介绍', services: '服务项目', interpretation: '专业翻译', booking: '预约诊疗', partners: '合作伙伴', community: '社区', myRes: '📅 预约记录', admin: '👑 管理员', stats: '📊 统计', logout: '退出', login: '登录' },
  ru: { langSelect: 'Выбор языка', home: 'Главная', about: 'О компании', services: 'Услуги', interpretation: 'Проф. перевод', booking: 'Запись на прием', partners: 'Партнеры', community: 'Сообщество', myRes: '📅 Мои записи', admin: '👑 Админ', stats: '📊 Статистика', logout: 'Выйти', login: 'Войти' },
  my: { langSelect: 'ဘာသာစကား', home: 'ပင်မစာမျက်နှာ', about: 'ကုမ္ပဏီအကြောင်း', services: 'ဝန်ဆောင်မှုများ', interpretation: 'ကျွမ်းကျင်စကားပြန်', booking: 'ရက်ချိန်းယူရန်', partners: 'မိတ်ဖက်များ', community: 'အသိုင်းအဝိုင်း', myRes: '📅 ရက်ချိန်းများ', admin: '👑 အဓိက', stats: '📊 စာရင်းအင်း', logout: 'ထွက်ရန်', login: 'ဝင်ရောက်ရန်' },
  km: { langSelect: 'ជ្រើសរើសភាសា', home: 'ទំព័រដើម', about: 'អំពីក្រុមហ៊ុន', services: 'សេវាកម្ម', interpretation: 'អ្នកបកប្រែជំនាញ', booking: 'កក់ការជួបពិភាក្សា', partners: 'ដៃគូ', community: 'សហគមន៍', myRes: '📅 ការកក់របស់ខ្ញុំ', admin: '👑 អ្នកគ្រប់គ្រង', stats: '📊 ស្ថិតិ', logout: 'ចាកចេញ', login: 'ចូល' },
  mn: { langSelect: 'Хэл сонгох', home: 'Нүүр', about: 'Компанийн тухай', services: 'Үйлчилгээ', interpretation: 'Мэргэжлийн орчуулга', booking: 'Цаг захиалах', partners: 'Харилцагч', community: 'Бүлгэм', myRes: '📅 Миний захиалга', admin: '👑 Админ', stats: '📊 Статистик', logout: 'Гарах', login: 'Нэвтрэх' },
  th: { langSelect: 'เลือกภาษา', home: 'หน้าแรก', about: 'เกี่ยวกับเรา', services: 'บริการ', interpretation: 'ล่ามมืออาชีพ', booking: 'นัดหมายแพทย์', partners: 'พันธมิตร', community: 'ชุมชน', myRes: '📅 การนัดหมายของฉัน', admin: '👑 ผู้ดูแลระบบ', stats: '📊 สถิติ', logout: 'ออกจากระบบ', login: 'เข้าสู่ระบบ' },
  lo: { langSelect: 'ເລືອກພາສາ', home: 'ໜ້າທຳອິດ', about: 'ກ່ຽວກັບພວກເຮົາ', services: 'ບໍລິການ', interpretation: 'ລ່າມມືອາຊີບ', booking: 'ນັດໝາຍ', partners: 'ພັນທະມິດ', community: 'ຊຸມຊົນ', myRes: '📅 ການນັດໝາຍຂອງຂ້ອຍ', admin: '👑 ຜູ້ดูแลระบบ', stats: '📊 ສະຖິຕິ', logout: 'ອອກຈາກລະບົບ', login: 'ເຂົ້າสู่ລະບົບ' },
  ne: { langSelect: 'भाषा छान्नुहोस्', home: 'गृहपृष्ठ', about: 'हाम्रो बारेमा', services: 'सेवाहरू', interpretation: 'व्यावसायिक दोभाषे', booking: 'अपोइन्टमेन्ट', partners: 'भागीदारहरू', community: 'समुदाय', myRes: '📅 मेरो अपोइन्टमेन्ट', admin: '👑 प्रशासक', stats: '📊 तथ्याङ्क', logout: 'लगआउट', login: 'लगइन' },
  id: { langSelect: 'Pilih Bahasa', home: 'Beranda', about: 'Tentang Kami', services: 'Layanan', interpretation: 'Penerjemah Profesional', booking: 'Buat Janji', partners: 'Mitra', community: 'Komunitas', myRes: '📅 Janji Saya', admin: '👑 Admin', stats: '📊 Statistik', logout: 'Keluar', login: 'Masuk' },
  si: { langSelect: 'භාෂාව තෝරන්න', home: 'මුල් පිටුව', about: 'අප ගැන', services: 'සේවා', interpretation: 'වෘත්තීය පරිවර්තක', booking: 'වෙන්කරවා ගැනීම', partners: 'පාර්ශවකරුවන්', community: 'ප්‍රජාව', myRes: '📅 මගේ වෙන්කිරීම්', admin: '👑 පරිපාලක', stats: '📊 සංඛ්‍යාලේඛන', logout: 'ලොග්අවුට්', login: 'ලොගින්' },
  bn: { langSelect: 'ভাষা নির্বাচন', home: 'হোম', about: 'আমাদের সম্পর্কে', services: 'সেবাসমূহ', interpretation: 'পেশাদার দোভাষী', booking: 'অ্যাপয়েন্টমেন্ট', partners: 'পার্টনার', community: 'কম্যুনিটি', myRes: '📅 আমার বুকিং', admin: '👑 অ্যাডমিন', stats: '📊 পরিসংখ্যান', logout: 'লগআউট', login: 'লগইন' }
};

/**
 * 전역 언어 변경 및 상단 메뉴 텍스트 실시간 동적 번역 적용 함수]
...
/**
 * 현재 선택된 언어에 맞춰 상단 네비게이션 메인 메뉴 DOM의 텍스트를 실시간으로 갱신하는 함수]
...
function applyNavTranslations(langCode) {
  ...
  // 0. 긴 다국어(미얀마, 스리랑카, 캄보디아, 라오스, 네팔, 태국, 방글라데시) 컴팩트 모드 클래스 토글
...
/**
 * 15개 언어 세로 수직 드롭다운 목록 HTML 조각 생성 함수]
 */
...
/**
 * 15개 언어 세로 목록을 정적/동적 드롭다운 영역에 동적으로 렌더링하고 이벤트를 바인딩하는 함수]
 */
...
/**
 * 언어 선택 드롭다운 패널 열기/닫기 토글 전용 전역 함수 (100% 무조건 작동 보장)]
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateActiveNavLinks(targetUrl) {
    ...
    links.forEach(link => {
      ...
      else if ((href === "/partners.html" || href === "/index.html#partners") && isPartnersActive) isActive = true;
  ...
  // 창 크기 조절 및 회전 이벤트 바인딩 및 즉시 1회 실행
  ...
  if (globalFooter) {
    ...
    globalFooter.innerHTML = `
        ...
        <div class="footer-links">
          <div class="footer-link-group">
            ...
            <ul>
              ...
              <!-- 공통 푸터 내 협력업체 전용 페이지 연결 링크 -->
              <li><a href="/partners.html">협력사 네트워크</a></li>
            </ul>
          </div>
          <div class="footer-link-group">
            <h4>진료 예약</h4>
      ...
      <div class="footer-bottom">
        ...
        <!-- 캡처본 요구사항에 맞춰 일관성 있게 구성된 최신 법인명 및 법인등록번호 표기 -->
